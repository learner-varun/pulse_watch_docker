...
import { useListEndpoints, useDeleteEndpoint, getListEndpointsQueryKey } from "@workspace/api-client-react";
          ...
          {endpoints.map((ep) => (
            ...
            >
              ...
              <Button 
                variant="ghost" 
                size="icon" 
                className="opacity-0 group-hover:opacity-100 shrink-0 text-destructive hover:text-destructive hover:bg-destructive/10"
